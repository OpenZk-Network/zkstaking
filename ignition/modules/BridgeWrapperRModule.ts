...
const BridgeMiddlewareRModule = buildModule("BridgeMiddlewareRModule", (m) => {
  ...
  const bridgeMiddlewareR = m.contract("BridgeMiddlewareR",
    [
      nativeCoinAddress,
      chainId,
      bridgeHubAddress,
  ...
  return { bridgeMiddlewareR };
});

export default BridgeMiddlewareRModule;
